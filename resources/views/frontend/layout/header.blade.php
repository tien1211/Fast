        ...
        <li class="nav-item active"><a href="{{route('index')}}" class="nav-link">Home</a></li>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown04">
              ...
              <a class="dropdown-item" href="shop.html">Sign in </a>
              <a class="dropdown-item" href="wishlist.html">Sign up</a>
              <a class="dropdown-item" href="product-single.html">Sign out</a>
